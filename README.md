...
- Processes queued prompts via configurable Antigravity command
- Falls back to comment insertion in active editor when Antigravity command is unavailable
...
5. In VS Code run **Agently: Process Queue with Antigravity** (or apply one item at a time).
